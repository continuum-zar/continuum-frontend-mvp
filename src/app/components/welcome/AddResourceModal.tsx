          ...
          <div className="z-[2] min-h-0 flex-1 overflow-x-clip overflow-y-auto bg-card px-9 py-6">
            <div className="flex w-full flex-col gap-6 pb-6">
              <div className="flex w-full flex-col gap-2">
                <div className="flex min-h-[235px] w-full flex-col items-center justify-center gap-3 rounded-[12px] border-2 border-dashed border-border px-4 py-6">
                  <input
                    ref={fileInputRef}
                    type="file"
                  ...
                  {pendingFile ? (
                    <p className="max-w-full truncate text-center font-['Satoshi',sans-serif] text-[13px] font-medium text-muted-foreground">
                      {pendingFile.name}
                    </p>
                  ) : null}
                </div>
                <div className="flex w-full items-start justify-between font-['Satoshi',sans-serif] text-[14px] font-normal whitespace-nowrap text-muted-foreground">
              ...
              <div className="flex w-full flex-col gap-1">
                ...
                <div className="flex h-10 w-full items-center rounded-[8px] border border-solid border-border bg-card px-4 py-2">
                  <input
                    ...
                    className="w-full min-w-0 border-0 bg-transparent font-['Satoshi',sans-serif] text-[16px] font-medium text-foreground outline-none placeholder:text-muted-foreground"
                  />
                </div>
              </div>
            ...
            <button
              ...
              className={cn(
                ...
                canSubmit
                  ...
                  : "cursor-not-allowed bg-muted-foreground/10 text-muted-foreground opacity-50"
              )}
