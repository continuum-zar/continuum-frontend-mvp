...
describe("TaskPanels", () => {
  ...
  it("requests logged hours when numeric project and task ids are present", async () => {
    mockUseTaskLoggedHoursTotal.mockReturnValue({
      data: 12.5,
      isLoading: false,
      isError: false,
  ...
  it("shows a loading indicator while hours are fetching", async () => {
    mockUseTaskLoggedHoursTotal.mockReturnValue({
      data: undefined,
      isLoading: true,
      isError: false,
  ...
  it("shows an error fallback when the hours query fails", async () => {
    mockUseTaskLoggedHoursTotal.mockReturnValue({
      data: undefined,
      isLoading: false,
      isError: true,
