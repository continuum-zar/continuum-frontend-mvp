...
/**
 * Same layout as {@link CreateProjectModal} — create milestone (name, description, due date).
 */
export function CreateMilestoneModal({ open, onOpenChange, projectId }: CreateMilestoneModalProps) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      // Toast handled in useCreateMilestone
    }
  };
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogPortal>
        ...
        >
          <DialogPrimitive.Title className="sr-only">Create Milestone</DialogPrimitive.Title>
          ...
          >
            ...
            <div className="flex w-full justify-end">
              <div className="w-[130px]">
                <button
                  type="button"
                  disabled={!name.trim() || !dueDate || createMilestone.isPending}
                  ...
                  className={cn(
                    ...
                    name.trim() && dueDate && !createMilestone.isPending
