          ...
          >
            ...
            <div className="flex w-full flex-col gap-6 px-9 py-6">
              <div className="flex items-start gap-3">
                ...
                <div className="flex min-w-0 flex-1 flex-col gap-1">
                  ...
                  <p className="font-['Satoshi',sans-serif] text-[14px] font-medium leading-relaxed text-muted-foreground">
                    {initialName.trim() ? (
                      <>
                        <span className="text-foreground">“{initialName.trim()}”</span> will be permanently removed. This
              ...
              <div className="flex w-full flex-col gap-2">
                <label htmlFor="edit-project-delete-confirm-name" className="font-['Satoshi',sans-serif] text-[14px] font-medium text-muted-foreground">
