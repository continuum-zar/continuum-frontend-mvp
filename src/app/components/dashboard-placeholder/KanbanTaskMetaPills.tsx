...
const pillShell =
  "bg-[#f0f3f5] content-stretch flex h-[24px] gap-[4px] items-center justify-center px-[12px] py-[4px] relative rounded-[16px] shrink-0";
...
export function KanbanTaskMetaPills({
  ...
  const rowClass = wrap
    ? "content-stretch flex max-w-full flex-wrap justify-end gap-[6px] items-start relative shrink min-w-0"
    : "content-stretch flex gap-[8px] h-[24px] items-start relative shrink-0";
