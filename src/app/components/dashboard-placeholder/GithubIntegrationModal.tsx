            ...
            {projectsLoading ? (
              ...
              <div className="flex flex-col gap-5">
                <div className="flex flex-col gap-1">
                  <label htmlFor="github-project" className="text-[14px] font-medium text-muted-foreground">
                    Continuum project
                  </label>
                  <Select
