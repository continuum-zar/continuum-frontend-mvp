...
const baseText =
    "text-[16px] font-medium leading-relaxed text-[#0b191f]";
...
const components: Components = {
    ...
    h1: ({ children }) => (
        <h1 className="mb-2 mt-4 first:mt-0 font-['Satoshi',sans-serif] text-[20px] font-semibold text-[#0b191f]">
            {children}
        </h1>
    ),
    h2: ({ children }) => (
        <h2 className="mb-2 mt-3 first:mt-0 font-['Satoshi',sans-serif] text-[18px] font-semibold text-[#0b191f]">
            {children}
        </h2>
    ),
    h3: ({ children }) => (
        <h3 className="mb-1.5 mt-2 first:mt-0 font-['Satoshi',sans-serif] text-[16px] font-semibold text-[#0b191f]">
            {children}
        </h3>
    ),
    ul: ({ children }) => (
        <ul className="mb-3 ml-5 list-disc space-y-1 marker:text-[#606d76] last:mb-0">
            {children}
        </ul>
    ),
    ol: ({ children }) => (
        <ol className="mb-3 ml-5 list-decimal space-y-1 marker:text-[#606d76] last:mb-0">
            {children}
        </ol>
    ),
    ...
    a: ({ children, href }) => (
        <a
            ...
            className="text-[#0866c2] underline underline-offset-2 hover:text-[#054a8c]"
        >
            {children}
        </a>
    ),
    code: ({ children }) => (
        <code className="rounded bg-[#f1f3f5] px-1.5 py-0.5 font-mono text-[13px] text-[#0b191f]">
            {children}
        </code>
    ),
    pre: ({ children }) => (
    ...
    blockquote: ({ children }) => (
        <blockquote className="mb-3 border-l-2 border-[#cbd1d6] pl-3 italic text-[#3d4a52] last:mb-0">
            {children}
        </blockquote>
    ),
    hr: () => <hr className="my-4 border-[#e9e9e9]" />,
};
