  ...
  return (
    <div className="p-8 pb-20">
      <div className="mb-8 flex justify-between items-end">
        <div>
          <h1 className="text-2xl mb-2">Metrics & Diagnostics</h1>
      ...
      >
        <motion.div variants={item} className="bg-card border border-border rounded-lg p-6 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-muted-foreground">Velocity Score</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        >
          <div className="mb-6 flex justify-between items-center">
            <div>
              <h3 className="mb-1">User Productivity Rhythm</h3>
