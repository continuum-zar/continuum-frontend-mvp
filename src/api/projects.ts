...
export const projectKeys = {
    ...
    assignedToMeTasks: (
        ...
        [...projectKeys.all, 'assigned-tasks', userId ?? 'signed-out', page ?? 1, pageSize ?? 'all'] as const,
    ...
    createdByMeTasks: (
        ...
        [...projectKeys.all, 'created-tasks', userId ?? 'signed-out', page ?? 1, pageSize ?? 'all'] as const,
