...
1. While signed in, open **`/cursor-mcp/task/<taskId>`** (for example from a deep link or after navigating from the product). The page title and body load task details from `GET /api/v1/cursor-mcp/task/:id`.
